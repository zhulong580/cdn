!function (t, e) {
    ...
    function X(t, e, n) {
        var r = B(t) ? L(t) : {}, i = t.parentNode || t.ownerDocument;
    ...
    function vt(t) {
        ...
        var l, c, u, h = a.url = t.uri || t.url, p = a.method = t.method || "GET", d = t.body || t.data, f = a.headers = t.headers || {}, v = !!t.sync, y = !1, g = {
            body: void 0,
            headers: {},
            statusCode: 0,
            method: p,
    ...
    function qt() {
        ...
        if ("string" == typeof a)qt(t, Lr[a], n, i, o, s); else if (a) {
            var c = a(i);
    ...
    var te, ee = "6.2.5", ne = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {};
    ...
    }(), je = /Safari/i.test(ue) && !we && !me && !ke, Ae = je || ye, Pe = h() && ("ontouchstart" in ie || ie.DocumentTouch && ie.document instanceof ie.DocumentTouch), Ne = h() && "backgroundSize" in ie.document.createElement("video").style, Oe = (Object.freeze || Object)({
        IS_IPAD: de,
        IS_IPHONE: fe,
        IS_IPOD: ve,
        IS_IOS: ye,
    ...
    var ze = Ve, Xe = function (t) {
        ...
        return e
    }, qe = Le(["Setting attributes in the second argument of createEl()\n                has been deprecated. Use the third argument instead.\n                createEl(type, properties, attributes). Attempting to set ", " to ", "."], ["Setting attributes in the second argument of createEl()\n                has been deprecated. Use the third argument instead.\n                createEl(type, properties, attributes). Attempting to set ", " to ", "."]), Ke = d("querySelector"), Ye = d("querySelectorAll"), Ge = (Object.freeze || Object)({
        isReal: h,
        isEl: p,
        createEl: f,
        textContent: v,
    ...
    var tn = ["touchstart", "touchmove"], en = (Object.freeze || Object)({
        fixEvent: W,
        on: U,
        off: z,
        trigger: X,
        one: q
    }), nn = !1, rn = void 0, on = function () {
        if (h()) {
    ...
    var fr = function (t) {
        function e() {
            var n, r, i = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
            Ie(this, e);
            var o = Q(i, {kind: Xn[i.kind] || ""}), s = n = Re(this, t.call(this, o)), a = !1;
        ...
        function e() {
            var n, r, i = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
            Ie(this, e);
            var o = Q(i, {kind: zn[i.kind] || ""}), s = n = Re(this, t.call(this, o)), a = !1;
            if (Se)for (var l in e.prototype)"constructor" !== l && (s[l] = e.prototype[l]);
    ...
    var Lr = {}, Br = {
        ...
        seekable: 1,
        played: 1
    }, Fr = {setCurrentTime: 1}, Vr = function t(e) {
        if (Array.isArray(e)) {
            var n = [];
        ...
        function e(n, r, i) {
            Ie(this, e);
            var o = Q({createEl: !1}, r), s = Re(this, t.call(this, n, o, i));
    ...
    var Ei = function (t) {
        function e(n, r, i) {
            Ie(this, e);
            var o = Re(this, t.call(this, n, r, i)), s = n.textTracks(), a = ln(o, o.handleTracksChange);
    ...
    Li.prototype.options_ = {children: ["playToggle", "volumePanel", "currentTimeDisplay", "timeDivider", "durationDisplay", "progressControl", "liveDisplay", "remainingTimeDisplay", "customControlSpacer", "playbackRateMenuButton", "chaptersButton", "descriptionsButton", "subsCapsButton", "audioTrackButton", "fullscreenToggle"]}, bn.registerComponent("ControlBar", Li);
    var Bi = function (t) {
        function e(n, r) {
            Ie(this, e);
            var i = Re(this, t.call(this, n, r));
    ...
    }, Zi.registerSourceHandler(Zi.nativeSourceHandler), Rr.registerTech("Html5", Zi);
